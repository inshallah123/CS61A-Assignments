...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        self.activities += 1
        self.transactions.append(Transaction(self.activities, self.balance - amount, self.balance))
        return self.balance
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.activities += 1
            self.transactions.append(Transaction(self.activities, self.balance, self.balance))
...
class Coin:
    ...
    def worth(self):
        ...
        values_added = (time_passed- 50) if time_passed > 50 else 0
        return self.cents + values_added
